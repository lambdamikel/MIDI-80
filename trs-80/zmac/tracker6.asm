...
PASS_U		equ	204		; PASSDIV main loop passes
SHORTDLY_U	equ	192		; SHORTDIV short_delays
WHLSLICE_U	equ	262		; one slice of the step delay
NEXTNOTE_U	equ	312		; nextnote bookkeeping
CURSOR_U	equ	156		; showplaycursor redraw
PLAYNOTES_U	equ	156		; playnotes / stoptracks dispatch
...
waitt:	ascii   '***** MIDI/80 TRACKER V1.99 - (C)2026 LAMBDAMIKEL + CLAUDE *****'
...
title:	ascii   '***** MIDI/80 TRACKER V1.99 - (C)2026 LAMBDAMIKEL + CLAUDE *****'
	ascii   'PAT:A SF | TRACK:1 SPEED:-- | B:8 S:04 | C:0 I:01 N:24 V:7F G:04'
	ascii	'1===-===+===-===2===-===+===-===3===-===+===-===4===-===+===-===' 
data:	ascii   '!...-...+...-...!...-...+...-...!...-...+...-...!...-...+...-...'
	ascii   '!...-...+...-...!...-...+...-...!...-...+...-...!...-...+...-...'
...
midiclkadd:
	...
	push bc			; A and DE are already clobbered by short_delay,
	push hl			; so only BC and HL need saving here

	ld hl,(steptime)	; steptime += de
	add hl,de
	ld (steptime),hl

	ld hl,(laststeptime)	; no period measured yet? warm up one step,
	ld a,h			; and do NOT let acc run away meanwhile
	or l
	jr z,midiclkadd4
...
midisteplatch:
	...
	ld a,h
	or l
	ret z			; first step: nothing measured yet
	ld (laststeptime),hl
	ld hl,0
	ld (steptime),hl
	ret
...
laststeptime	word 0		; previous step total = the clock period basis
