...
title2          defb  '    SONGNAME: NEIL_DIAMOND_-_Beautiful_noise', ENTER
title3		defb  ENTER
...
mididata equ 	$
	...
	incbin 'midibin/NEIL_DIAMOND_-_Beautiful_noise0.bin'
	incbin 'midibin/NEIL_DIAMOND_-_Beautiful_noise1.bin'
