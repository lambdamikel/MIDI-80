...
title2          defb  '    SONGNAME: Rockin_Around_The_Christmas_Tree', ENTER
title3		defb  ENTER
...
mididata equ 	$
	...
	incbin 'midibin/Rockin_Around_The_Christmas_Tree0.bin'
	incbin 'midibin/Rockin_Around_The_Christmas_Tree1.bin'
