...
title2          defb  '    SONGNAME: Crocketts Theme - Miami Vice Soundtrack', ENTER
title3		defb  ENTER
...
mididata equ 	$
	...
	incbin 'midibin/Crocketts Theme - Miami Vice Soundtrack0.bin'
	incbin 'midibin/Crocketts Theme - Miami Vice Soundtrack1.bin'
