...
title2          defb  '    SONGNAME: Always On My Mind  Pet Shop Boys', ENTER
title3		defb  ENTER
...
mididata equ 	$
	...
	incbin 'midibin/Always On My Mind  Pet Shop Boys0.bin'
	incbin 'midibin/Always On My Mind  Pet Shop Boys1.bin'
