...
title2          defb  '    SONGNAME: QUEEN_-_Another_one_bites_the_dust', ENTER
title3		defb  ENTER
...
mididata equ 	$
	...
	incbin 'midibin/QUEEN_-_Another_one_bites_the_dust0.bin'
	incbin 'midibin/QUEEN_-_Another_one_bites_the_dust1.bin'
